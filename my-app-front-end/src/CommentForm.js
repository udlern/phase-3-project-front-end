...
function CommentForm() {
  ...
  return (
    <div className="comment-form">
      <form>
      <Button onClick={handleOpen}>Click to add a comment!</Button>
      <Modal
        open={open}
        onClose={handleClose}
      ...
      <InputLabel id="demo-simple-select-label">Employees</InputLabel>
        ...
        <br />
        <label>
        <TextField id="comment-input" value={comment} onChange={handleOnChangeComment} label="Type your comment here!" variant="outlined" />
        </label>
